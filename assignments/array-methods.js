...
let ticketPriceTotal = runners.reduce((theReducer, x) => {
    return theReducer += x.donation
}, 0);
...
// Problem 1
//Filter emails with .edu ++ provide discount
let eduEmail = runners.filter((x) => {
    return x.email.includes(".edu")
});
